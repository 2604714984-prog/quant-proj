"""Frozen statistics for the removable C90 multi-horizon consensus lane."""
...
RESEARCH_ID = "C90_MULTI_HORIZON_RELATIVE_LEADERSHIP_CONSENSUS_SPY_QQQ_V1"
