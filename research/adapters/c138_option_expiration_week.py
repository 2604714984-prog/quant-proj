"""Frozen statistics for removable C138 option-expiration-week research."""
...
RESEARCH_ID = "C138_SPY_OPTION_EXPIRATION_WEEK_PREMIUM_V1"
INITIAL_CAPITAL = 40_000.0
VALIDATION_INTERVALS = 125
HOLDOUT_INTERVALS = 152
PROGRAM_ALPHA = 0.05
BOOTSTRAP_RESAMPLES = 100_000
BOOTSTRAP_BLOCK_WEEKS = 4
BOOTSTRAP_SEED = 13_800_101


class InputContractError(ValueError):
    """Raised when the frozen return or inference contract is violated."""
...
def validation_decision(
    ...
    gates = (
        ...
        (
            "strategy_terminal_net_wealth_strictly_above_initial_capital",
            strategy_performance.terminal_wealth > 1.0,
        ),
        ("arithmetic_mean_paired_active_return_strictly_positive", mean_active > 0.0),
        (
            "strategy_maximum_drawdown_no_worse_than_fourth_friday_comparator",
...
def holdout_decision(
    ...
    gates = (
        ...
        ("exactly_152_paired_intervals", len(active) == HOLDOUT_INTERVALS),
        (
