"""Frozen statistics for the removable C98 volume-expansion attention lane."""
...
RESEARCH_ID = "C98_RELATIVE_VOLUME_EXPANSION_ATTENTION_ROTATION_SPY_QQQ_V1"
