"""Frozen statistics for the removable C149 Empire State SPY/QQQ lane."""
...
RESEARCH_ID = "C149_NYFED_EMPIRE_CURRENT_BUSINESS_STATE_ROTATION_SPY_QQQ_V1"
