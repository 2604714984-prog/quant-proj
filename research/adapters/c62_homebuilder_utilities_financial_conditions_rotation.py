"""Frozen statistics for the removable Cycle 62 homebuilder/utilities lane."""
...
RESEARCH_ID = "C62_HOMEBUILDER_UTILITIES_FINANCIAL_CONDITIONS_ROTATION_SPY_QQQ_V1"
