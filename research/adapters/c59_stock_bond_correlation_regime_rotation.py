"""Frozen statistics for the removable Cycle 59 stock-bond-correlation lane."""
...
RESEARCH_ID = "C59_STOCK_BOND_CORRELATION_REGIME_ROTATION_SPY_QQQ_V1"
