"""Frozen statistics for the removable C97 close-location accumulation lane."""
...
RESEARCH_ID = "C97_RELATIVE_CLOSE_LOCATION_ACCUMULATION_ROTATION_SPY_QQQ_V1"
