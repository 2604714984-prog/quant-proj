"""Frozen statistics for the removable Cycle 19 DGS10 SPY/QQQ lane."""
...
def holdout_decision(
    ...
    gates = (
        ...
        (
            "centered_null_one_sided_p_at_most_0_00000019073486328125",
            inference.centered_null_one_sided_p <= PROGRAM_ALPHA,
        ),
        (
            "uncentered_type7_0_00000019073486328125_lower_bound_strictly_positive",
