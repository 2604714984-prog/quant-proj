"""Frozen statistics for the removable Cycle 8 NFCI/SPY research lane."""
...
RESEARCH_ID = "C8_NFCI_MONTHLY_TIGHTENING_IMPULSE_SPY_CASH_V1"
INITIAL_CAPITAL = 40_000.0
VALIDATION_INTERVALS = 28
HOLDOUT_INTERVALS = 34
PROGRAM_ALPHA = 0.000390625
BOOTSTRAP_RESAMPLES = 10_000
BOOTSTRAP_BLOCK_MONTHS = 3
BOOTSTRAP_SEED = 1_198_101
...
def holdout_decision(
    ...
    gates = (
        ...
        (
            "centered_null_one_sided_p_at_most_0_000390625",
            inference.centered_null_one_sided_p <= PROGRAM_ALPHA,
        ),
        (
            "uncentered_type7_0_000390625_lower_bound_strictly_positive",
