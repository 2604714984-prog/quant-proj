"""Frozen statistics for the removable Cycle 13 M2 SPY/QQQ research lane."""
...
def holdout_decision(
    ...
    gates = (
        ...
        (
            "centered_null_one_sided_p_at_most_0_00001220703125",
            inference.centered_null_one_sided_p <= PROGRAM_ALPHA,
        ),
        (
            "uncentered_type7_0_00001220703125_lower_bound_strictly_positive",
