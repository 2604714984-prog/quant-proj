"""Frozen statistics for the removable C141 FINRA short-flow rotation lane."""
...
RESEARCH_ID = "C141_FINRA_RELATIVE_OFF_EXCHANGE_SHORT_SALE_FLOW_ROTATION_SPY_QQQ_V1"
...
def _paired(
    ...
    return strategy, comparator, spy, active
...
def validation_decision(
    ...
    strategy, comparator, spy, active = _paired(
        strategy_returns,
        comparator_returns,
        spy_returns,
...
def holdout_decision(
    ...
    gates = (
        ...
        ("exactly_156_paired_intervals", len(active) == HOLDOUT_INTERVALS),
        (
