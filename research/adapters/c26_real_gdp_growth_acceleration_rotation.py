"""Frozen statistics for the removable Cycle 26 A191RL1Q225SBEA SPY/QQQ lane."""
...
RESEARCH_ID = "C26_REAL_GDP_GROWTH_ACCELERATION_ROTATION_SPY_QQQ_V1"
INITIAL_CAPITAL = 40_000.0
VALIDATION_INTERVALS = 28
HOLDOUT_INTERVALS = 34
PROGRAM_ALPHA = 0.000000001490116119384765625
BOOTSTRAP_RESAMPLES = 1_024_000_000
BOOTSTRAP_BLOCK_MONTHS = 3
BOOTSTRAP_SEED = 2_300_101
...
def holdout_decision(
    ...
    gates = (
        ...
        (
            "centered_null_one_sided_p_at_most_0_000000011920928955078125",
            inference.centered_null_one_sided_p <= PROGRAM_ALPHA,
        ),
        (
            "uncentered_type7_0_000000011920928955078125_lower_bound_strictly_positive",
