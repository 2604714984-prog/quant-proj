"""Frozen statistics for the removable C75 relative-volatility lane."""
...
RESEARCH_ID = "C75_RELATIVE_REALIZED_VOLATILITY_COMPRESSION_ROTATION_SPY_QQQ_V1"
