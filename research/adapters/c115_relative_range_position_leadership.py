"""Frozen statistics for the removable C115 relative-range-position-leadership rotation lane."""
...
RESEARCH_ID = "C115_RELATIVE_RANGE_POSITION_LEADERSHIP_ROTATION_SPY_QQQ_V1"
