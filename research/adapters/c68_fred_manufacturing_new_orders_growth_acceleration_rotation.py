"""Frozen statistics for the removable C68 manufacturing-orders SPY/QQQ lane."""
...
RESEARCH_ID = "C68_FRED_MANUFACTURING_NEW_ORDERS_GROWTH_ACCELERATION_ROTATION_SPY_QQQ_V1"
