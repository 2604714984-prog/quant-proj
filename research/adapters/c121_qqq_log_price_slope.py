"""Frozen statistics for the removable C121 qqq-log-price-slope rotation lane."""
...
RESEARCH_ID = "C121_QQQ_63_SESSION_LOG_PRICE_SLOPE_ROTATION_SPY_QQQ_V1"
