"""Frozen statistics for the removable Cycle 17 industrial-production SPY/QQQ research lane."""
...
RESEARCH_ID = "C17_INDUSTRIAL_PRODUCTION_DIRECTION_SPY_QQQ_ROTATION_V1"
INITIAL_CAPITAL = 40_000.0
VALIDATION_INTERVALS = 28
HOLDOUT_INTERVALS = 34
PROGRAM_ALPHA = 0.000000762939453125
BOOTSTRAP_RESAMPLES = 4_000_000
BOOTSTRAP_BLOCK_MONTHS = 3
BOOTSTRAP_SEED = 1_500_501
...
def holdout_decision(
    ...
    gates = (
        ...
        (
            "centered_null_one_sided_p_at_most_0_000000762939453125",
            inference.centered_null_one_sided_p <= PROGRAM_ALPHA,
        ),
        (
            "uncentered_type7_0_000000762939453125_lower_bound_strictly_positive",
