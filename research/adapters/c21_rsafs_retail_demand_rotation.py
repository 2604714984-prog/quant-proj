"""Frozen statistics for the removable Cycle 21 RSAFS SPY/QQQ lane."""
...
RESEARCH_ID = "C21_RSAFS_RETAIL_DEMAND_ROTATION_SPY_QQQ_V1"
INITIAL_CAPITAL = 40_000.0
VALIDATION_INTERVALS = 28
HOLDOUT_INTERVALS = 34
PROGRAM_ALPHA = 0.0000000476837158203125
BOOTSTRAP_RESAMPLES = 32_000_000
BOOTSTRAP_BLOCK_MONTHS = 3
BOOTSTRAP_SEED = 1_800_901
...
def holdout_decision(
    ...
    gates = (
        ...
        (
            "centered_null_one_sided_p_at_most_0_0000000476837158203125",
            inference.centered_null_one_sided_p <= PROGRAM_ALPHA,
        ),
        (
            "uncentered_type7_0_0000000476837158203125_lower_bound_strictly_positive",
