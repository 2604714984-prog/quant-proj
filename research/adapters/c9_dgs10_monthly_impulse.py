"""Frozen statistics for the removable Cycle 9 DGS10/SPY research lane."""
...
RESEARCH_ID = "C9_DGS10_MONTHLY_YIELD_IMPULSE_SPY_CASH_V1"
INITIAL_CAPITAL = 40_000.0
VALIDATION_INTERVALS = 28
HOLDOUT_INTERVALS = 34
PROGRAM_ALPHA = 0.0001953125
BOOTSTRAP_RESAMPLES = 10_000
BOOTSTRAP_BLOCK_MONTHS = 3
BOOTSTRAP_SEED = 1_199_101
...
def holdout_decision(
    ...
    gates = (
        ...
        (
            "centered_null_one_sided_p_at_most_0_0001953125",
            inference.centered_null_one_sided_p <= PROGRAM_ALPHA,
        ),
        (
            "uncentered_type7_0_0001953125_lower_bound_strictly_positive",
