"""Frozen statistics for the removable C118 qqq-14-session-rsi-state rotation lane."""
...
RESEARCH_ID = "C118_QQQ_14_SESSION_RSI_STATE_ROTATION_SPY_QQQ_V1"
