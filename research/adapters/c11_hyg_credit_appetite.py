"""Frozen statistics for the removable Cycle 11 HYG/SPY research lane."""
...
def holdout_decision(
    ...
    gates = (
        ...
        (
            "centered_null_one_sided_p_at_most_0_000048828125",
            inference.centered_null_one_sided_p <= PROGRAM_ALPHA,
        ),
        (
            "uncentered_type7_0_000048828125_lower_bound_strictly_positive",
