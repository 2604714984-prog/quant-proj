"""Frozen statistics for the removable C67 policy-uncertainty SPY/QQQ lane."""
...
RESEARCH_ID = "C67_FRED_US_ECONOMIC_POLICY_UNCERTAINTY_IMPULSE_ROTATION_SPY_QQQ_V1"
