"""Frozen statistics for the removable Cycle 10 VIX20/SPY research lane."""
...
RESEARCH_ID = "C10_VIX_20_FEAR_REGIME_SPY_CASH_V1"
INITIAL_CAPITAL = 40_000.0
VALIDATION_INTERVALS = 28
HOLDOUT_INTERVALS = 34
PROGRAM_ALPHA = 0.00009765625
BOOTSTRAP_RESAMPLES = 20_000
BOOTSTRAP_BLOCK_MONTHS = 3
BOOTSTRAP_SEED = 1_200_101
...
def holdout_decision(
    ...
    gates = (
        ...
        (
            "centered_null_one_sided_p_at_most_0_00009765625",
            inference.centered_null_one_sided_p <= PROGRAM_ALPHA,
        ),
        (
            "uncentered_type7_0_00009765625_lower_bound_strictly_positive",
