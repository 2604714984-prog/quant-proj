"""Frozen statistics for the removable Cycle 20 T10YIE SPY/QQQ lane."""
...
RESEARCH_ID = "C20_T10YIE_INFLATION_EXPECTATION_ROTATION_SPY_QQQ_V1"
INITIAL_CAPITAL = 40_000.0
VALIDATION_INTERVALS = 28
HOLDOUT_INTERVALS = 34
PROGRAM_ALPHA = 0.000000095367431640625
BOOTSTRAP_RESAMPLES = 16_000_000
BOOTSTRAP_BLOCK_MONTHS = 3
BOOTSTRAP_SEED = 1_700_801
...
def holdout_decision(
    ...
    gates = (
        ...
        (
            "centered_null_one_sided_p_at_most_0_000000095367431640625",
            inference.centered_null_one_sided_p <= PROGRAM_ALPHA,
        ),
        (
            "uncentered_type7_0_000000095367431640625_lower_bound_strictly_positive",
