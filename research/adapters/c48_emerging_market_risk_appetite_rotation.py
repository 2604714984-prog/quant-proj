"""Frozen statistics for the removable Cycle 48 emerging market risk appetite lane."""
...
RESEARCH_ID = "C48_EMERGING_MARKET_RISK_APPETITE_ROTATION_SPY_QQQ_V1"
INITIAL_CAPITAL = 40_000.0
VALIDATION_INTERVALS = 28
HOLDOUT_INTERVALS = 34
PROGRAM_ALPHA = 0.016666666666666666
BOOTSTRAP_RESAMPLES = 100_000
BOOTSTRAP_BLOCK_MONTHS = 3
BOOTSTRAP_SEED = 4_800_101
...
def holdout_decision(
    ...
    gates = (
        ...
        (
            "centered_null_one_sided_p_at_most_0_016666666666666667",
            inference.centered_null_one_sided_p <= PROGRAM_ALPHA,
        ),
        (
            "uncentered_type7_0_016666666666666667_lower_bound_strictly_positive",
