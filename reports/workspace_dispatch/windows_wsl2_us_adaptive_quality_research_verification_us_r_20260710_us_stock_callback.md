...
> Superseded by `WINDOWS_WSL2_US_ADAPTIVE_QUALITY_FINAL_BINARY_ADJUDICATION_20260710`. Current decision: `REJECT`; disposition: `BENCHMARK_ONLY`.
...
STATUS: SUPERSEDED_BY_FINAL_BINARY_REJECT
...
DIAGNOSTICS_STATUS: SUPERSEDED; historical optimization source used test-result scoring.
FINAL_US01_LABEL: BENCHMARK_ONLY
...
NEXT_SOURCE_ACTION: None for the current configuration; final binary decision is REJECT.
