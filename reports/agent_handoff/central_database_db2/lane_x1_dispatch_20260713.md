# Database DB2 Lane X1 Dispatch

BATCH_ID: CENTRAL_DB_DB2_X1_20260713
LANE_ID: X1
PRIORITY: P3
TARGET_DATABASE: /home/rongyu/workspace/quant_data/quant_research.duckdb
TARGET_TABLES: a_share_feature_store|us_feature_store|regime_feature_store
...
SOURCE_POLICY: deterministic derivation from accepted snapshots
SYMBOL_SCOPE: accepted upstream datasets only
DATE_RANGE: upstream qualified ranges
REQUIRED_FIELDS: entity|as_of|feature|value|source_dataset|source_snapshot_id|formula|lookback|minimum_periods|available_time|PIT_status|derivation_commit|hash
PRIMARY_KEY: must be frozen per physical table before execution; duplicate count must be zero
PIT_REQUIREMENTS: inherit strictest upstream availability
ADJUSTMENT_REQUIREMENTS: documented per feature
CORPORATE_ACTION_REQUIREMENTS: inherit upstream action identity
QUALITY_THRESHOLDS: undocumented derived columns=0; reproducible hash parity
DEPENDENCIES: A0|A1|A2|A3|A4|A5|A6|U0|U1|U2|U3|U4|U5|U6
...
CALLBACK_SCHEMA: DERIVED_FEATURE_STORE_READY
GITHUB_BRANCH: codex/central-db-db2-x1-20260713
