# Database DB2 Lane U4 Dispatch

BATCH_ID: CENTRAL_DB_DB2_U4_20260713
LANE_ID: U4
PRIORITY: P2
TARGET_DATABASE: /home/rongyu/workspace/quant_data/quant_research.duckdb
TARGET_TABLES: us_volatility_daily|us_rates_daily|us_credit_context_daily|us_macro_releases_pit
...
SOURCE_POLICY: CBOE/Treasury/FRED/BLS/BEA official public sources
SYMBOL_SCOPE: approved public market/macro series
DATE_RANGE: full qualified history
REQUIRED_FIELDS: series_id|observation_date|value|release_timestamp|vintage|revision|available_at|source|quality_status
PRIMARY_KEY: must be frozen per physical table before execution; duplicate count must be zero
PIT_REQUIREMENTS: original release and vintages retained; revisions not backdated
ADJUSTMENT_REQUIREMENTS: not applicable
CORPORATE_ACTION_REQUIREMENTS: not applicable
QUALITY_THRESHOLDS: duplicate vintage keys=0; release chronology pass; missing vintages declared
DEPENDENCIES: U0
...
CALLBACK_SCHEMA: US_CONTEXT_PIT_READY
GITHUB_BRANCH: codex/central-db-db2-u4-20260713
