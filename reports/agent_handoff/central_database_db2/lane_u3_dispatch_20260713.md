# Database DB2 Lane U3 Dispatch

BATCH_ID: CENTRAL_DB_DB2_U3_20260713
LANE_ID: U3
PRIORITY: P1
...
SYMBOL_SCOPE: XLK|XLF|XLE|XLV|XLI|XLP|XLY|XLB|XLU|XLRE|XLC
DATE_RANGE: inception through latest completed session
...
QUALITY_THRESHOLDS: duplicate keys=0; pre-inception fabrication=0; coverage declared
DEPENDENCIES: U0|U1
...
CALLBACK_SCHEMA: US_DB_CALLBACK_P1
GITHUB_BRANCH: codex/central-db-db2-u3-20260713
