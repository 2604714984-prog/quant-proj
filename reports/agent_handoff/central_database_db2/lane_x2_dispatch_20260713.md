# Database DB2 Lane X2 Dispatch

BATCH_ID: CENTRAL_DB_DB2_X2_20260713
LANE_ID: X2
PRIORITY: P3
TARGET_DATABASE: /home/rongyu/workspace/quant_data/quant_research.duckdb
TARGET_TABLES: meta.dataset_catalog|meta.snapshot_registry|meta.quality_runs|meta.routine_append_runs
...
SOURCE_POLICY: accepted ingestion profiles only
SYMBOL_SCOPE: all accepted datasets
DATE_RANGE: continuous operations
REQUIRED_FIELDS: dataset_id|snapshot_id|source_health|stale_at|schema_hash|quality_status|receipt_sha256|rollback_reference
PRIMARY_KEY: must be frozen per physical table before execution; duplicate count must be zero
PIT_REQUIREMENTS: no weakening of upstream PIT contract
ADJUSTMENT_REQUIREMENTS: no weakening of upstream adjustment contract
CORPORATE_ACTION_REQUIREMENTS: no weakening of upstream action contract
QUALITY_THRESHOLDS: idempotent update; stale/schema/duplicate guards; immutable receipts and exports
DEPENDENCIES: ALL_ACCEPTED_LANES
...
CALLBACK_SCHEMA: CENTRAL_DB_FULL_DATA_CALLBACK
GITHUB_BRANCH: codex/central-db-db2-x2-20260713
