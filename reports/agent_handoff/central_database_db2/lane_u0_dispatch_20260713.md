# Database DB2 Lane U0 Dispatch

BATCH_ID: CENTRAL_DB_DB2_U0_20260713
LANE_ID: U0
PRIORITY: P0
TARGET_DATABASE: /home/rongyu/workspace/quant_data/quant_research.duckdb
TARGET_TABLES: us_trade_calendar|us_symbol_master_history
...
SOURCE_POLICY: NYSE/Nasdaq/SEC official public sources and accepted authorized cross-check
SYMBOL_SCOPE: NYSE/Nasdaq ETFs and equities required by U1-U6
DATE_RANGE: calendar 2010-01-01 through current year end; symbol full history
REQUIRED_FIELDS: symbol|session_date|open_time|close_time|half_day|exchange|asset_type|currency|inception_date|delist_date|effective_from|effective_to|available_at|source
PRIMARY_KEY: must be frozen per physical table before execution; duplicate count must be zero
PIT_REQUIREMENTS: historically effective identities; current-only membership is unqualified
ADJUSTMENT_REQUIREMENTS: not applicable
CORPORATE_ACTION_REQUIREMENTS: ticker changes/delist lifecycle required
QUALITY_THRESHOLDS: duplicate keys=0; holidays/half-days complete; no invented pre-inception rows
...
CALLBACK_SCHEMA: US_DB_CALLBACK_P0_CALENDAR
GITHUB_BRANCH: codex/central-db-db2-u0-20260713
