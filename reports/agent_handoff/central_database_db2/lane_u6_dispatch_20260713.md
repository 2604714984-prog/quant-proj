# Database DB2 Lane U6 Dispatch

BATCH_ID: CENTRAL_DB_DB2_U6_20260713
LANE_ID: U6
PRIORITY: P2
TARGET_DATABASE: /home/rongyu/workspace/quant_data/quant_research.duckdb
TARGET_TABLES: us_fundamentals_pit|us_earnings_events_pit|us_estimate_surprise_pit
...
SOURCE_POLICY: SEC EDGAR primary documents; estimates only from separately licensed source
SYMBOL_SCOPE: U5 accepted universe
DATE_RANGE: full SEC-available history
REQUIRED_FIELDS: symbol|accession|report_period|accepted_at|available_at|concept|value|unit|revision|source_sha256|quality_status
PRIMARY_KEY: must be frozen per physical table before execution; duplicate count must be zero
PIT_REQUIREMENTS: acceptance timestamp/accession/revision identity required
ADJUSTMENT_REQUIREMENTS: statement/restatement handling required
CORPORATE_ACTION_REQUIREMENTS: issuer/ticker lifecycle linkage required
QUALITY_THRESHOLDS: duplicate accession/concept keys=0; restatements append only; primary identity pass
DEPENDENCIES: U0|U5
...
CALLBACK_SCHEMA: US_PIT_FUNDAMENTALS_EARNINGS_CALLBACK
GITHUB_BRANCH: codex/central-db-db2-u6-20260713
