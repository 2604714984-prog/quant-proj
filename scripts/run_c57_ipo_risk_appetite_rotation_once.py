"""One-use runner for the frozen Cycle 57 IPO risk-appetite SPY/QQQ lane."""
...
from research.adapters.c57_ipo_risk_appetite_rotation import (  # noqa: E402
    HOLDOUT_INTERVALS,
    INITIAL_CAPITAL,
    PROGRAM_ALPHA,
    RESEARCH_ID,
...
DEFINITION = ROOT / "research/definitions/c57_ipo_risk_appetite_rotation_v1.json"
ADAPTER = ROOT / "research/adapters/c57_ipo_risk_appetite_rotation.py"
RUNNER = Path(__file__).resolve()
DEFINITION_SHA256 = "937bed4e515fc45d1864c3fdb1688cd6a606fa2f89ced1b8065026ca968fc90b"
ADAPTER_SHA256 = "db4371e824abcb7fa77749aefb95e3515ec5d2b213bbfdf5744365689d179910"
SIGNAL_SHA256 = "86b5bbd7c56855c13f521a1a76bbef557ce1f979db8a3b8c2a0a73147b191470"
RECEIPT_SHA256 = "93d1b8f82ffcf5adb17fafa89123905c65c931217cbb1bb6c28be1fb44152af4"
...
SIGNAL_INPUT = Path(
    ...
    "c57_ipo_risk_appetite_rotation_spy_qqq_v1/"
...
def _load_bundle(
    ...
    *,
    ...
    packet = _json(input_payload, "IPO risk appetite rotation input packet")
    receipt = _json(
        receipt_payload,
        "IPO risk appetite materialization receipt",
    )
    ...
    if (
        ...
        or receipt.get("left_symbol") != "IPO"
    ...
    for index, raw in enumerate(raw_points):
        ...
        if signal is not None and (
            ...
            raise InputBlockedError(
                "IPO risk appetite signal does not bind the execution schedule"
            )
        try:
...
def _claim(stage: str, runner_sha: str, bundle_sha: str, validation_result_sha: str | None) -> dict[str, Any]:
    return {
        "schema_version": "c57-ipo-risk-appetite-claim-v1",
...
def _result(
    ...
    *,
    ...
    return {
        "schema_version": "c57-ipo-risk-appetite-result-v1",
        "research_id": RESEARCH_ID,
        "stage": stage,
