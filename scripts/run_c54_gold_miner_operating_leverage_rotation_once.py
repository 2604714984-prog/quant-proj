"""One-use runner for the frozen Cycle 54 gold-miner leverage SPY/QQQ lane."""
...
from research.adapters.c54_gold_miner_operating_leverage_rotation import (  # noqa: E402
    HOLDOUT_INTERVALS,
    INITIAL_CAPITAL,
    PROGRAM_ALPHA,
    RESEARCH_ID,
...
DEFINITION = ROOT / "research/definitions/c54_gold_miner_operating_leverage_rotation_v1.json"
ADAPTER = ROOT / "research/adapters/c54_gold_miner_operating_leverage_rotation.py"
RUNNER = Path(__file__).resolve()
DEFINITION_SHA256 = "d704cd3c1eb28c17e5479de2a1927e438a328fe6f0e53598f1504ff1cad40679"
ADAPTER_SHA256 = "39125714ae55cf1e4cea41bbe02e6eb17e2203165c47bdd3a2fc02115ca93948"
SIGNAL_SHA256 = "7ccb77d25acfa74d3bd7fe7f1e7f1a254a8f9ccc0f3372e08907c750bf5b53fd"
RECEIPT_SHA256 = "7c4a4253b1bcb52ea548dde9b0156f903707c5b4fb095060ed09dd645426d0a3"
...
SIGNAL_INPUT = Path(
    ...
    "c54_gold_miner_operating_leverage_rotation_spy_qqq_v1/"
...
def _signals(payload: bytes) -> dict[str, tuple[Signal, ...]]:
    record = _json(payload, "gold miner operating leverage rotation input packet")
    expected_contract = {
        "left_symbol": "GDX",
        "right_symbol": "GLD",
        "return_window": (
    ...
    if (
        ...
        or record.get("gld_price_values_used_for_materialization") is not True
...
def _load_bundle(
    ...
    *,
    ...
    if (
        ...
        or receipt.get("left_symbol") != "GDX"
...
def _claim(stage: str, runner_sha: str, bundle_sha: str, validation_result_sha: str | None) -> dict[str, Any]:
    return {
        "schema_version": "c54-gold-miner-leverage-claim-v1",
...
def _result(
    ...
    *,
    ...
    return {
        "schema_version": "c54-gold-miner-leverage-result-v1",
        "research_id": RESEARCH_ID,
        "stage": stage,
