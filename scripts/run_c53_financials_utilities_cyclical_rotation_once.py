"""One-use runner for the frozen Cycle 53 financials/utilities SPY/QQQ lane."""
...
from research.adapters.c53_financials_utilities_cyclical_rotation import (  # noqa: E402
    HOLDOUT_INTERVALS,
    INITIAL_CAPITAL,
    PROGRAM_ALPHA,
    RESEARCH_ID,
...
DEFINITION = ROOT / "research/definitions/c53_financials_utilities_cyclical_rotation_v1.json"
ADAPTER = ROOT / "research/adapters/c53_financials_utilities_cyclical_rotation.py"
RUNNER = Path(__file__).resolve()
DEFINITION_SHA256 = "034c90190ed4d680736c784875cfeeeb4c157bc445aeb025ca53c1b5787ef9d9"
ADAPTER_SHA256 = "9aaa96c0ae47eceb95c6204f8128ac95fc927b3d7a3df69faa2425f2676652d9"
SIGNAL_SHA256 = "fed18ad0c8ef2ff813f8c1f7788ec72387657dd60fe1e88425cd5ec4f09fb540"
RECEIPT_SHA256 = "1c74f5f989d0a3689d3e06a9eb24c526e3b9879f4e8c8d26984b44b09f2cabb1"
...
SIGNAL_INPUT = Path(
    ...
    "c53_financials_utilities_cyclical_rotation_spy_qqq_v1/"
...
def _signals(payload: bytes) -> dict[str, tuple[Signal, ...]]:
    record = _json(payload, "financials utilities cyclical rotation input packet")
    expected_contract = {
        "left_symbol": "XLF",
        "right_symbol": "XLU",
        "return_window": (
        ...
        "target_rule": (
            "strict XLF prior-month total-return outperformance versus XLU "
    ...
    expected_source = {
        "XLF": (
            ...
            "e0abfe71fb6020b966962c07c541f9fdb11779d1684b674241c9f4eecf8fd0f6",
        ),
        "XLU": (
            "https://query1.finance.yahoo.com/v8/finance/chart/XLU?"
            "period1=1604188800&period2=1782864000&interval=1d&"
            "events=div%2Csplits&includeAdjustedClose=true",
            "014ff1a7dc81d734abc7806f2fa850568f12532c8aa81143c046948cb10c1133",
        ),
    }
...
def _load_bundle(
    ...
    *,
    ...
    if (
        ...
        or receipt.get("left_symbol") != "XLF"
...
def _claim(stage: str, runner_sha: str, bundle_sha: str, validation_result_sha: str | None) -> dict[str, Any]:
    return {
        "schema_version": "c53-financials-utilities-claim-v1",
...
def _result(
    ...
    *,
    ...
    return {
        "schema_version": "c53-financials-utilities-result-v1",
        "research_id": RESEARCH_ID,
        "stage": stage,
