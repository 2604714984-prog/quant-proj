"""One-use runner for the frozen Cycle 51 equal-weight breadth SPY/QQQ lane."""
...
from research.adapters.c51_equal_weight_breadth_rotation import (  # noqa: E402
    HOLDOUT_INTERVALS,
    INITIAL_CAPITAL,
    PROGRAM_ALPHA,
    RESEARCH_ID,
...
DEFINITION = ROOT / "research/definitions/c51_equal_weight_breadth_rotation_v1.json"
ADAPTER = ROOT / "research/adapters/c51_equal_weight_breadth_rotation.py"
RUNNER = Path(__file__).resolve()
DEFINITION_SHA256 = "e53dda17ec60aae6dd630bae138421c63b48dfc9e6723436bfe539b885eceb49"
ADAPTER_SHA256 = "88bb3a674e1f53703cbd280c4be24b6e9eedbc329bc7a6c28213dc33fe160eba"
SIGNAL_SHA256 = "6b6c533b383815197af4c36178c0341770ed0372607840378963906652359791"
RECEIPT_SHA256 = "c92e4bac12e3fb9d985075487a84519cf8f633d25144ad7cff470458c97d3321"
...
SIGNAL_INPUT = Path(
    ...
    "c51_equal_weight_breadth_rotation_spy_qqq_v1/"
...
def _signals(payload: bytes) -> dict[str, tuple[Signal, ...]]:
    record = _json(payload, "equal weight breadth rotation input packet")
    expected_contract = {
        "left_symbol": "RSP",
        "right_symbol": "SPY",
        "return_window": (
        ...
        "target_rule": (
            "strict RSP prior-month total-return outperformance versus SPY "
    ...
    if (
        ...
        raise InputBlockedError("equal weight breadth packet boundary mismatch")
    rows = record.get("signals")
    if type(rows) is not list or len(rows) != VALIDATION_INTERVALS + HOLDOUT_INTERVALS:
        raise InputBlockedError("equal weight breadth signal row count mismatch")
    ...
    expected_source = {
        "RSP": (
            ...
            "00b5823eff491fe91ba4aba2724e833a5c8890ce0d022bee0241a2d98d896926",
        ),
        "SPY": (
...
def _load_bundle(
    ...
    *,
    ...
    packet = _json(input_payload, "equal weight breadth rotation input packet")
    receipt = _json(
        receipt_payload,
        "equal weight breadth materialization receipt",
    )
    ...
    if (
        ...
        or receipt.get("left_symbol") != "RSP"
...
def _claim(stage: str, runner_sha: str, bundle_sha: str, validation_result_sha: str | None) -> dict[str, Any]:
    return {
        "schema_version": "c51-equal-weight-breadth-claim-v1",
...
def _result(
    ...
    *,
    ...
    return {
        "schema_version": "c51-equal-weight-breadth-result-v1",
        "research_id": RESEARCH_ID,
        "stage": stage,
