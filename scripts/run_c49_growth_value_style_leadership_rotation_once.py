"""One-use runner for the frozen Cycle 49 growth/value style SPY/QQQ lane."""
...
from research.adapters.c49_growth_value_style_leadership_rotation import (  # noqa: E402
    HOLDOUT_INTERVALS,
    INITIAL_CAPITAL,
    PROGRAM_ALPHA,
    RESEARCH_ID,
...
DEFINITION = ROOT / "research/definitions/c49_growth_value_style_leadership_rotation_v1.json"
ADAPTER = ROOT / "research/adapters/c49_growth_value_style_leadership_rotation.py"
RUNNER = Path(__file__).resolve()
DEFINITION_SHA256 = "1e47793b2bc5f1ea77a71a9d7716bc17da6d7daee298edbded12debaacceea53"
ADAPTER_SHA256 = "c533e2c0918ca19dce33bbbd794abe72a107a22d5db41a54adf2e41fcbc9bf26"
SIGNAL_SHA256 = "c8dd0c04bb9824c746e7651cf12f42226c7080cf8e78b8298c04ff6c12e418c0"
RECEIPT_SHA256 = "5596fa825394e1b37f476933be2cf302116a63ebc752c97656bbc350d0004a24"
...
SIGNAL_INPUT = Path(
    ...
    "c49_growth_value_style_leadership_rotation_spy_qqq_v1/"
...
def _signals(payload: bytes) -> dict[str, tuple[Signal, ...]]:
    record = _json(payload, "growth value style leadership rotation input packet")
    expected_contract = {
        "left_symbol": "VUG",
        "right_symbol": "VTV",
        "return_window": (
        ...
        "target_rule": (
            "strict VUG prior-month total-return outperformance versus VTV "
    ...
    expected_source = {
        "VUG": (
            "https://query1.finance.yahoo.com/v8/finance/chart/VUG?"
            "period1=1604188800&period2=1782864000&interval=1d&"
            "events=div%2Csplits&includeAdjustedClose=true",
            "c069aa7f6655d9e6bc5585191db7ed6916b36b58225130507e7502d4599c31f7",
        ),
        "VTV": (
            "https://query1.finance.yahoo.com/v8/finance/chart/VTV?"
            "period1=1604188800&period2=1782864000&interval=1d&"
            "events=div%2Csplits&includeAdjustedClose=true",
            "499d22c421c53f47b158c803d17d6f6e6a2959a44546dc5c8f2614470c79a510",
        ),
    }
...
def _load_bundle(
    ...
    *,
    ...
    if (
        ...
        or receipt.get("left_symbol") != "VUG"
        or receipt.get("right_symbol") != "VTV"
...
def _claim(stage: str, runner_sha: str, bundle_sha: str, validation_result_sha: str | None) -> dict[str, Any]:
    return {
        "schema_version": "c49-growth-value-style-claim-v1",
...
def _result(
    ...
    *,
    ...
    return {
        "schema_version": "c49-growth-value-style-result-v1",
        "research_id": RESEARCH_ID,
        "stage": stage,
