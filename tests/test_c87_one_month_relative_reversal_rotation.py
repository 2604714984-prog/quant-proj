...
from research.adapters import c87_one_month_relative_reversal_rotation as adapter
from research.adapters.c87_one_month_relative_reversal_rotation import (
...
from scripts import run_c87_one_month_relative_reversal_rotation_once as runner
...
def test_frozen_definition_adapter_and_program_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 8_700_101
...
def test_definition_is_single_variant_outcome_blind_and_nontrading() -> None:
    ...
    assert record["program_multiplicity"]["epoch40_mechanism_count"] == 1
...
def _synthetic_signal_packet() -> bytes:
    ...
    for stage, first, count in (
        ...
        for index in range(count):
            ...
            formation_start = signal_session - timedelta(days=40)
            ...
            spy_sum = 0.10
            qqq_sum = 0.00 if index % 2 == 0 else 0.20
            relative_sum = qqq_sum - spy_sum
            target = "QQQ" if relative_sum < 0.0 else "SPY"
            ...
            row = {
                ...
                "return_count": 21,
                "spy_log_return_sum": spy_sum,
                "qqq_log_return_sum": qqq_sum,
                "qqq_minus_spy_log_return_sum": relative_sum,
    ...
    return json.dumps(
        {
            "schema_version": "c87-one-month-relative-reversal-input-v1",
            ...
            "signal_contract": {
                ...
                "relative_sum": (
                    "sum of QQQ log returns minus sum of SPY log returns"
                ),
                "target_rule": (
                    "strictly negative relative sum means QQQ; zero or positive "
                    "means SPY"
                ),
                "tie_break": "SPY",
            },
