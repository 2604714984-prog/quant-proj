...
from research.adapters import c90_multi_horizon_relative_leadership_consensus as adapter
from research.adapters.c90_multi_horizon_relative_leadership_consensus import (
...
from scripts import run_c90_multi_horizon_relative_leadership_consensus_once as runner
...
def test_frozen_definition_adapter_and_program_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 9_000_101
...
def test_definition_is_single_variant_outcome_blind_and_nontrading() -> None:
    ...
    assert record["program_multiplicity"]["epoch43_mechanism_count"] == 1
...
def _synthetic_signal_packet() -> bytes:
    ...
    for stage, first, count in (
        ...
        for index in range(count):
            ...
            relative = 0.10 if index % 2 == 0 else -0.10
            qqq_votes = 3 if relative > 0.0 else 0
            target = "QQQ" if qqq_votes >= 2 else "SPY"
            ...
            row = {
                ...
                "spy_log_return_sum_21": 0.0,
                "qqq_log_return_sum_21": relative,
                "relative_log_return_sum_21": relative,
                "spy_log_return_sum_63": 0.0,
                "qqq_log_return_sum_63": relative,
                "relative_log_return_sum_63": relative,
                "spy_log_return_sum_126": 0.0,
                "qqq_log_return_sum_126": relative,
                "relative_log_return_sum_126": relative,
                "qqq_positive_horizon_votes": qqq_votes,
                "return_count": 126,
    ...
    return json.dumps(
        {
            "schema_version": "c90-multi-horizon-relative-leadership-consensus-input-v1",
            ...
            "signal_contract": {
                ...
                "relative_return": (
                    "QQQ log-return sum minus SPY log-return sum"
                ),
                "vote_rule": (
                    "strictly positive relative return casts QQQ; zero or "
                    "negative casts SPY"
                ),
                "target_rule": (
