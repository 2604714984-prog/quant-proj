...
from research.adapters import c37_cboe_cor1m_change_rotation as adapter
from research.adapters.c37_cboe_cor1m_change_rotation import (
...
from scripts import run_c37_cboe_cor1m_change_rotation_once as runner
...
def test_frozen_definition_adapter_and_program_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 3_700_101
...
def _synthetic_signal_packet() -> bytes:
    rows = []
    state_support = {}
    raw_sha = "d3ac35e1b3504fc9dd3cca26724904b42e8ec77eddfff72516a641d24d884c61"
    ...
    return json.dumps(
        {
            "schema_version": "c37-cboe-cor1m-change-spy-qqq-input-packet-v1",
