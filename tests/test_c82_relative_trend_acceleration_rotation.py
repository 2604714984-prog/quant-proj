...
from research.adapters import c82_relative_trend_acceleration_rotation as adapter
from research.adapters.c82_relative_trend_acceleration_rotation import (
...
from scripts import run_c82_relative_trend_acceleration_rotation_once as runner
...
def test_frozen_definition_adapter_and_program_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 8_200_101
...
def test_definition_is_single_variant_outcome_blind_and_nontrading() -> None:
    ...
    assert record["program_multiplicity"]["epoch35_mechanism_count"] == 1
...
def _synthetic_signal_packet() -> bytes:
    ...
    for stage, first, count in (
        ...
        for index in range(count):
            ...
            older_sum = 0.10
            recent_sum = 0.20 if index % 2 == 0 else 0.00
            acceleration = recent_sum - older_sum
            target = "QQQ" if acceleration > 0.0 else "SPY"
            ...
            row = {
                ...
                "return_count_per_block": 63,
                "older_relative_return_sum": older_sum,
                "recent_relative_return_sum": recent_sum,
                "relative_trend_acceleration": acceleration,
    ...
    return json.dumps(
        {
            "schema_version": "c82-relative-trend-acceleration-input-v1",
            ...
            "signal_contract": {
                ...
                "target_rule": (
                    "strictly positive acceleration means QQQ; zero or negative "
                    "means SPY"
                ),
                "tie_break": "SPY",
            },
