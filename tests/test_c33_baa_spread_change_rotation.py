...
from research.adapters import c33_baa_spread_change_rotation as adapter
from research.adapters.c33_baa_spread_change_rotation import (
...
from scripts import run_c33_baa_spread_change_rotation_once as runner
...
def test_frozen_definition_adapter_and_program_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 3_300_101
...
def _synthetic_signal_packet() -> bytes:
        ...
        for index in range(count):
            ...
            def source(value: float, cutoff: date, observation: date) -> dict:
                identity = {
                    ...
                    "source_class": "OFFICIAL_ALFRED_BAA10YM",
                }
                return {
                    **identity,
            ...
            identity = {
                ...
                "delta_percentage_points_vs_prior_calendar_month": delta,
    ...
    return json.dumps(
        {
            "schema_version": "c33-baa10ym-spread-change-spy-qqq-input-packet-v1",
