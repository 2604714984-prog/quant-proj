...
from research.adapters import c124_qqq_pearson_kurtosis as adapter
from research.adapters.c124_qqq_pearson_kurtosis import (
...
from scripts import run_c124_qqq_pearson_kurtosis_once as runner
...
def test_frozen_definition_adapter_core_and_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 12_400_101
...
def _synthetic_signal_packet() -> bytes:
    ...
    for stage, first, count in (
        ...
        for index in range(count):
            ...
            qqq_pearson_kurtosis = 2.5 if index % 2 == 0 else 4.0
            target = "QQQ" if qqq_pearson_kurtosis <= 3.0 else "SPY"
            ...
            row: dict[str, object] = {
                ...
                "qqq_pearson_kurtosis": qqq_pearson_kurtosis,
    ...
    return json.dumps(
        {
            "schema_version": "c124-qqq-pearson-kurtosis-input-v1",
            ...
            "signal_contract": {
                ...
                "score_definition": (
                    "Pearson population kurtosis m4 divided by m2 squared from "
...
def test_signal_packet_rejects_signal_and_target_tampering() -> None:
    ...
    record["signals"][0]["qqq_pearson_kurtosis"] = 42.0
