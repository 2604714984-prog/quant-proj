...
from research.adapters import c88_relative_return_skewness_rotation as adapter
from research.adapters.c88_relative_return_skewness_rotation import (
...
from scripts import run_c88_relative_return_skewness_rotation_once as runner
...
def test_frozen_definition_adapter_and_program_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 8_800_101
...
def test_definition_is_single_variant_outcome_blind_and_nontrading() -> None:
    ...
    assert record["program_multiplicity"]["epoch41_mechanism_count"] == 1
...
def _synthetic_signal_packet() -> bytes:
    ...
    for stage, first, count in (
        ...
        for index in range(count):
            ...
            spy_second = 0.01
            spy_third = 0.001
            spy_skewness = spy_third / (spy_second**1.5)
            qqq_second = 0.01
            qqq_third = 0.002 if index % 2 == 0 else 0.0
            qqq_skewness = qqq_third / (qqq_second**1.5)
            ...
            row = {
                ...
                "return_count": 126,
                "spy_mean_log_return": 0.001,
                "spy_second_central_moment": spy_second,
                "spy_third_central_moment": spy_third,
                "spy_population_skewness": spy_skewness,
                "qqq_mean_log_return": 0.002,
                "qqq_second_central_moment": qqq_second,
                "qqq_third_central_moment": qqq_third,
                "qqq_population_skewness": qqq_skewness,
                "relative_skewness_difference": difference,
    ...
    return json.dumps(
        {
            "schema_version": "c88-relative-return-skewness-input-v1",
...
def test_real_input_bytes_are_hash_bound_and_signals_match_frozen_support() -> None:
    ...
    assert (validation.count("SPY"), validation.count("QQQ")) == (8, 20)
