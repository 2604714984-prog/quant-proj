...
from research.adapters import c107_spy_realized_volatility_regime as adapter
from research.adapters.c107_spy_realized_volatility_regime import (
...
from scripts import run_c107_spy_realized_volatility_regime_once as runner
...
def test_frozen_definition_adapter_core_and_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 10_700_101
...
def test_definition_is_one_variant_outcome_blind_and_nontrading() -> None:
    ...
    assert multiplicity["epoch60_mechanism_count"] == 1
...
def _synthetic_signal_packet() -> bytes:
    ...
    for stage, first, count in (
        ...
        for index in range(count):
            ...
            recent_volatility = 0.01 if index % 2 == 0 else 0.03
            difference = recent_volatility - baseline_volatility
            ...
            row: dict[str, object] = {
                ...
                "baseline_spy_realized_volatility": baseline_volatility,
                "baseline_return_count": 231,
                "realized_volatility_difference": difference,
                "recent_spy_realized_volatility": recent_volatility,
                "recent_return_count": 21,
    ...
    return json.dumps(
        {
            "schema_version": "c107-spy-realized-volatility-regime-input-v1",
            ...
            "signal_contract": {
                ...
                "target_rule": (
                    ...
                    "231-return volatility selects QQQ; equality or higher "
                    "selects SPY"
                ),
            },
            "signals": rows,
...
def test_signal_packet_rejects_arithmetic_and_target_tampering() -> None:
    ...
    record["signals"][0]["realized_volatility_difference"] = 0.2
