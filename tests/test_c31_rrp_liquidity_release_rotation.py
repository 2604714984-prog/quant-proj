...
from research.adapters import c31_rrp_liquidity_release_rotation as adapter
from research.adapters.c31_rrp_liquidity_release_rotation import (
...
from scripts import run_c31_rrp_liquidity_release_rotation_once as runner
...
def test_frozen_definition_adapter_and_program_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 3_100_101
...
def test_definition_is_single_variant_outcome_blind_and_nontrading() -> None:
    ...
    assert record["program_multiplicity"]["epoch2_mechanism_count"] == 3
...
def _synthetic_signal_packet() -> bytes:
        ...
        for index in range(count):
            ...
            def source(value: float, cutoff: date, observation: date) -> dict:
                identity = {
                    ...
                    "source_class": "OFFICIAL_ALFRED_NEW_YORK_FED_RRPONTTLD",
                }
                return {
                    **identity,
            ...
            identity = {
                ...
                "previous_reference_date": previous_reference.isoformat(),
                "current_reference_date": current_reference.isoformat(),
                "current_row_sha256": current["row_sha256"],
                "previous_row_sha256": previous["row_sha256"],
                "delta_billions_usd_versus_prior_28_day_anchor": delta,
    ...
    return json.dumps(
        {
            "schema_version": "c31-rrp-liquidity-release-spy-qqq-input-packet-v1",
