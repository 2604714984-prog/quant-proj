...
from research.adapters import c38_cboe_vvix_change_rotation as adapter
from research.adapters.c38_cboe_vvix_change_rotation import (
...
from scripts import run_c38_cboe_vvix_change_rotation_once as runner
...
def test_frozen_definition_adapter_and_program_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 3_800_101
...
def _synthetic_signal_packet() -> bytes:
    rows = []
    state_support = {}
    raw_sha = "abafc34b5b50b9cbe1657758e5c0c2065c229f9eb60a2bf66712d7e77fb3eb49"
    ...
    for stage, first, count in (
        ...
        for index in range(count):
            ...
            current_value, baseline_value = (
                (101.0, 100.0) if index % 2 == 0 else (99.0, 100.0)
            )
            ...
            def source(value: float, observed: date) -> dict:
                identity = {
                    ...
                    "retrieved_at": "2026-07-23T15:01:04.300885+08:00",
                }
                return {
                    **identity,
    ...
    return json.dumps(
        {
            "schema_version": "c38-cboe-vvix-change-spy-qqq-input-packet-v1",
