...
from research.adapters import c61_move_rate_volatility_impulse_rotation as adapter
from research.adapters.c61_move_rate_volatility_impulse_rotation import (
...
from scripts import run_c61_move_rate_volatility_impulse_rotation_once as runner
...
def test_frozen_definition_adapter_and_program_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 6_100_101
...
def test_definition_is_single_variant_outcome_blind_and_nontrading() -> None:
    ...
    assert record["program_multiplicity"]["epoch14_mechanism_count"] == 1
...
def _synthetic_signal_packet() -> bytes:
    rows = []
    state_support = {}
    raw_sha = "0e6ea915738b90c09cfc0aef7b4653e86df492c113fe2c1389a6c5a840227e5f"
    url = (
    ...
    for stage, first, count in (
        ...
        for index in range(count):
            ...
            current_value, previous_value = (
                (99.0, 100.0) if index % 2 == 0 else (101.0, 100.0)
            )
    ...
    return json.dumps(
        {
            "schema_version": "c61-move-impulse-input-packet-v1",
            ...
            "signal_contract": {
                ...
                "target_rule": (
                    "strict MOVE decline selects QQQ; equality or increase selects SPY"
                ),
