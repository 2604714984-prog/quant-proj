...
from research.adapters import c25_ic4wsa_labor_stress_rotation as adapter
from research.adapters.c25_ic4wsa_labor_stress_rotation import (
...
from scripts import run_c25_ic4wsa_labor_stress_rotation_once as runner
...
def test_frozen_definition_adapter_and_program_constants_are_exact() -> None:
    ...
    assert PROGRAM_ALPHA == 0.00000000298023223876953125
    assert BOOTSTRAP_RESAMPLES == 512_000_000
    assert BOOTSTRAP_BLOCK_MONTHS == 3
    assert BOOTSTRAP_SEED == 2_200_101
...
def _synthetic_signal_packet() -> bytes:
        ...
        for index in range(count):
            ...
            def source(value: float, cutoff: date, observation: date) -> dict:
                identity = {
                    ...
                    "source_class": "OFFICIAL_ALFRED_IC4WSA",
                }
                return {
                    **identity,
            ...
            identity = {
                ...
                "previous_reference_week": previous_reference.isoformat(),
                "current_reference_week": current_reference.isoformat(),
                "current_row_sha256": current["row_sha256"],
                "previous_row_sha256": previous["row_sha256"],
                "delta_claimants_versus_28_days_prior": delta,
    ...
    return json.dumps(
        {
            "schema_version": "c25-ic4wsa-labor-stress-rotation-spy-qqq-input-packet-v1",
