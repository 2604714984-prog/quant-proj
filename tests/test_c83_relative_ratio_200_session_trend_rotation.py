...
from research.adapters import c83_relative_ratio_200_session_trend_rotation as adapter
from research.adapters.c83_relative_ratio_200_session_trend_rotation import (
...
from scripts import run_c83_relative_ratio_200_session_trend_rotation_once as runner
...
def test_frozen_definition_adapter_and_program_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 8_300_101
...
def test_definition_is_single_variant_outcome_blind_and_nontrading() -> None:
    ...
    assert record["program_multiplicity"]["epoch36_mechanism_count"] == 1
...
def _synthetic_signal_packet() -> bytes:
    ...
    for stage, first, count in (
        ...
        for index in range(count):
            ...
            formation_start = signal_session - timedelta(days=300)
            ...
            reference = 0.10
            final_ratio = 0.20 if index % 2 == 0 else 0.00
            distance = final_ratio - reference
            target = "QQQ" if distance > 0.0 else "SPY"
            ...
            row = {
                ...
                "reference_mean_log_ratio": reference,
                "final_log_ratio": final_ratio,
                "relative_trend_distance": distance,
    ...
    return json.dumps(
        {
            "schema_version": "c83-relative-ratio-200-session-trend-input-v1",
            ...
            "signal_contract": {
                ...
                "target_rule": (
                    "final log ratio strictly above the reference means QQQ; "
...
def test_real_input_bytes_are_hash_bound_and_signals_match_frozen_support() -> None:
    ...
    assert (holdout.count("SPY"), holdout.count("QQQ")) == (12, 22)
