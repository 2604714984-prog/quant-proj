...
from research.adapters import c77_positive_day_participation_rotation as adapter
from research.adapters.c77_positive_day_participation_rotation import (
...
from scripts import run_c77_positive_day_participation_rotation_once as runner
...
def test_frozen_definition_adapter_and_program_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 7_700_101
...
def test_definition_is_single_variant_outcome_blind_and_nontrading() -> None:
    ...
    assert record["program_multiplicity"]["epoch30_mechanism_count"] == 1
...
def _synthetic_signal_packet() -> bytes:
    ...
    for stage, first, count in (
        ...
        for index in range(count):
            ...
            spy_positive_days = 32
            qqq_positive_days = 33 if index % 2 == 0 else 31
            target = "QQQ" if qqq_positive_days > spy_positive_days else "SPY"
            ...
            row = {
                ...
                "return_count": 63,
                "spy_positive_day_count": spy_positive_days,
                "qqq_positive_day_count": qqq_positive_days,
    ...
    return json.dumps(
        {
            "schema_version": "c77-positive-day-participation-input-v1",
            ...
            "signal_contract": {
                ...
                "positive_day_count": (
                    "count of natural-log returns strictly greater than zero; "
                    "zero is not positive"
                ),
                "target_rule": (
                    "QQQ positive-day count strictly above SPY means QQQ; "
