...
from research.adapters import c64_cboe_skew_tail_risk_impulse_rotation as adapter
from research.adapters.c64_cboe_skew_tail_risk_impulse_rotation import (
...
from scripts import run_c64_cboe_skew_tail_risk_impulse_rotation_once as runner
...
def test_frozen_definition_adapter_and_program_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 6_400_101
...
def test_definition_is_single_variant_outcome_blind_and_nontrading() -> None:
    ...
    assert record["program_multiplicity"]["epoch17_mechanism_count"] == 1
...
def _synthetic_signal_packet() -> bytes:
    rows = []
    state_support = {}
    raw_sha = "21cca8b0d43aa9d2d5eb25d78d42dbe4b8a652c27fced06783ce3c5ca1a11ba0"
    url = (
    ...
    return json.dumps(
        {
            "schema_version": "c64-skew-tail-risk-impulse-input-packet-v1",
            ...
            "signal_contract": {
                ...
                "target_rule": (
                    "strict SKEW decline selects QQQ; equality or increase selects SPY"
                ),
