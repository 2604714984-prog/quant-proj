...
from research.adapters import c105_qqq_beta_compression as adapter
from research.adapters.c105_qqq_beta_compression import (
...
from scripts import run_c105_qqq_beta_compression_once as runner
...
def test_frozen_definition_adapter_core_and_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 10_500_101
...
def test_definition_is_one_variant_outcome_blind_and_nontrading() -> None:
    ...
    assert multiplicity["epoch58_mechanism_count"] == 1
...
def _synthetic_signal_packet() -> bytes:
    ...
    for stage, first, count in (
        ...
        for index in range(count):
            ...
            baseline_beta = 1.0
            recent_beta = 0.9 if index % 2 == 0 else 1.1
            difference = recent_beta - baseline_beta
            ...
            row: dict[str, object] = {
                ...
                "baseline_qqq_beta_to_spy": baseline_beta,
                "baseline_return_count": 42,
                "beta_compression_difference": difference,
                "recent_qqq_beta_to_spy": recent_beta,
    ...
    return json.dumps(
        {
            "schema_version": "c105-qqq-beta-compression-input-v1",
...
def test_signal_packet_rejects_arithmetic_and_target_tampering() -> None:
    ...
    record["signals"][0]["beta_compression_difference"] = 0.2
