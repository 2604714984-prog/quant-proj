...
from research.adapters import c106_trailing_median_vix as adapter
from research.adapters.c106_trailing_median_vix import (
...
from scripts import run_c106_trailing_median_vix_once as runner
...
def test_frozen_definition_adapter_core_and_constants_are_exact() -> None:
    ...
    assert BOOTSTRAP_SEED == 10_600_101
...
def test_definition_is_one_variant_outcome_blind_and_nontrading() -> None:
    ...
    assert multiplicity["epoch59_mechanism_count"] == 1
...
def _synthetic_signal_packet() -> bytes:
    ...
    for stage, first, count in (
        ...
        for index in range(count):
            ...
            trailing_median = 20.0
            current_vix = 19.0 if index % 2 == 0 else 21.0
            ...
            row: dict[str, object] = {
                ...
                "current_vix_close": current_vix,
                "formation_session_count": 252,
                ...
                "trailing_median_vix": trailing_median,
                "vix_minus_trailing_median": difference,
            }
    ...
    return json.dumps(
        {
            "schema_version": "c106-trailing-median-vix-input-v1",
            ...
            "implied_volatility_values_used_for_signal": True,
...
def test_signal_packet_rejects_arithmetic_and_target_tampering() -> None:
    ...
    record["signals"][0]["vix_minus_trailing_median"] = 0.2
